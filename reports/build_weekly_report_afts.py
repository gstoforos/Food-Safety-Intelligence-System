...
.header{{border-bottom:3px solid #00ff88;margin-bottom:30px;padding-bottom:20px;}}
...
.contact a{{color:#00ff88;text-decoration:none;}}
...
.dashboard-link{{background:#00ff88;color:#fff;padding:10px 20px;text-decoration:none;border-radius:5px;display:inline-block;margin:15px 0;}}
