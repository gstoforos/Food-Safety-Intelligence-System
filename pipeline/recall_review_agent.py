...
2. Read the page. For EACH field, decide if the row's value matches the page.
   ...
   - Company and Brand must appear VERBATIM on the page. If you cannot find a
     brand named on the page, the Brand is "Unbranded" — never invent one.
   - If the page says the product is sold loose / at the counter / à la coupe
     / vendu au rayon / sans marque / "unbranded", then Brand = "Unbranded"
     and Company is the responsible distributor/retailer named on the page
     (e.g. the supermarket chain), NOT a made-up producer name.
   - If a previous step already put a brand/company on the row but the page
   ...
   - A plausible-sounding brand that is not on the page is a HALLUCINATION.
     When unsure, use "Unbranded" / leave Company empty and return
