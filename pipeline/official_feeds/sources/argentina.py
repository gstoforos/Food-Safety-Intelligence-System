...
LISTING_URLS = (
    "https://www.argentina.gob.ar/anmat/alertas/alimentos",
...
def _try_fetch(url: str) -> str | None:
    return _http_get(url, timeout=_LISTING_TIMEOUT,
                     retries=_LISTING_RETRIES, label="ANMAT")
...
ARGENTINA = FeedSource(
    ...
    authority_domain="argentina.gob.ar/anmat",
    authority_url_pattern=r"(comunicados|alertas|noticias)/[^/]+",
)
